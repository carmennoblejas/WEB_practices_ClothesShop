  ...
  return (
    <form className='group space-y-6' onSubmit={handleSubmit} noValidate>
      ...
      <div>
        <button
          type='submit'
          className="mt-6 mx-auto block bg-primary hover:bg-primary-hover text-white dark:text-text-dark-main px-6 py-3 rounded font-semibold shadow-md transition"
        >
          Sign in
        </button>
      </div>
